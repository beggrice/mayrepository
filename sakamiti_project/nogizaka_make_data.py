...
root_dir="D:\\nogizakaout\\"
categories=["out_akimotomanatu","out_etoumisa","out_higuchihina","out_horimiona","out_hosinominami","out_ikutaerika","out_inouesayuri",
            "out_itoujunnna","out_itouriria","out_iwamotorennka","out_kitanohinako","out_matumurasayuri","out_mukaihaduki","out_nakadakana",
            "out_nakamurareno","out_nisinonanase","out_oozonomomoko","out_saitouasuka","out_saitouyuuri","out_sakaguchitamami","out_sakuraireika",
            "out_sasakikotoko","out_satoukaede","out_sinnuchimai","out_siraisimai","out_suzukiayane","out_takayamakazumi",
            "out_teradarannze","out_umezawaminami","out_yamasitamiduki"]
...
np.save("D:\\train_test\\all6obj.npy",xy)
